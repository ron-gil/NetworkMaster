...
#define IOCTL_END_PACKET_LOGGING   CTL_CODE(FILE_DEVICE_UNKNOWN, 0x7fe, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define PACKET_LOGGING_LAYER FWPM_LAYER_INBOUND_MAC_FRAME_ETHERNET
